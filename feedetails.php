...
$sql1 = "SELECT * FROM tblstudent_info WHERE FeeSubmitted='Y' ORDER BY DeptName, EnrollmentNo";
                ...
                <div class="row">
                    <div class="collapse navbar-collapse" id="myNavbar">
                        <ul class="nav navbar-nav menu-title   navbar-right">
                            ...
                            <li class="active"><a href="feedetails.php">Deposited Fee Status</a></li>
