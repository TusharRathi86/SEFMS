...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1751344591ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbproject&table=tblstudent_info">`dbproject`.`tblstudent_info`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbproject&table=tbldeptmaster">`dbproject`.`tbldeptmaster`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbproject&table=tblstudentfee">`dbproject`.`tblstudentfee`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbproject&table=tbtlogininfo">`dbproject`.`tbtlogininfo`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbproject&table=tblaccountdetails">`dbproject`.`tblaccountdetails`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="2e376f423a3370307a30366a5e256942">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="dbproject" targettable="tblstudent_info">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tblstudent_info`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dbproject" targettable="tblstudent_info">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">ALTER TABLE `tblstudent_info` ADD COLUMN `id` INT AUTO_INCREMENT UNIQUE FIRST;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dbproject" targettable="tblstudent_info">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT MAX(id) FROM `tblstudent_info`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dbproject" targettable="tblstudent_info">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT MAX(ID) as maximunID FROM tblstudent_info;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dbproject" targettable="tblstudent_info">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT MAX(ID) as maxRC FROM tblstudent_info;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dbproject" targettable="tblstudent_info">
                            <div class="action_content">
